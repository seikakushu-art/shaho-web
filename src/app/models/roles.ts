export enum RoleKey {
  ...
  export const roleDirectory: Record<string, RoleKey> = {
    'admin@example.com': RoleKey.SystemAdmin,
    'approver@example.com': RoleKey.Approver,
    'staff@example.com': RoleKey.Operator,
    'guest@example.com': RoleKey.Guest,
  };